...
class UIPrediction:
    ...
    def create_ui(self):
        ...
        self.tree.heading("Avg. Area Number of Rooms", text="Avg. Area Number of Room")
        self.tree.heading("Avg. Area Number of Bedrooms", text="Avg. Area Number of Bedroom")
        ...
        designedby_label = Label(designedby_panel, text="Designed by: Tran The Vinh")
    ...
    def do_load_model(self):
        ...
        button = Button(root, text="OK", command=lambda: print("value is:", variable.get()))
        button.pack()
